...
//if user searches for their own profile, redirect to main page
...
<head>
    ...
    <style>
        ...
        .profile-meta { color: #666; margin-top: 5px; }
        ...
        .stat-label { color: #666; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 1px; margin-top: 5px; }
