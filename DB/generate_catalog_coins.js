...
const MATERIALS = [
    'Copper-Nickel', 'Bronze', 'Silver', 'Steel', 'Aluminium', 
    'Gold', 'Zinc', 'Copper', 'Brass', 'Bi-Metallic'
];
        ...
        files.forEach(file => {
            ...
            if (!file.includes('(1)')) {
                ...
                if (match) {
                    ...
                    values.push(`(@bg_id, '${title}', '${denomination}', ${year}, '${period}', '${material}', ${weight}, ${diameter}, ${thickness}, ${mintage}, '${dbPathFront}', '${dbPathBack}', @admin_id, 1)`);
                }
            }
        });
